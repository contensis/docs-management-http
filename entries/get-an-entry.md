...
An entry definition in the Management API contains a mixture of standard properties and properties that have been defined by the content type that an [entry](https://zenhub.zengenti.com/Contensis/11.2/kb/content-types-and-entries/entries/entries-overview.aspx) is based on.
